...
namespace Evidencija.northwndDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Evidencija.Properties.Settings.Default.northwndConnectionString;
        }
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [Order Details]\r\nWHERE        (OrderID = @Original_OrderID)";
            ...
            this._commandCollection[2].CommandText = "SELECT        OrderID, ProductID, UnitPrice, Quantity, Discount\r\nFROM            " +
        ...
        public virtual int DeleteByOrderID(int Original_OrderID) {
